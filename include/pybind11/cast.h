...
public:
    ...
    void load_value(value_and_holder &&v_h) {
        auto *&vptr = v_h.xxx_value_ptr<void>();  // holder_type not available here.
...
public:
    ...
    bool load(handle h, bool) {
        ...
        if (bases.size() == 1) { // Only allowing loading from a single-value type
            value = values_and_holders(reinterpret_cast<instance *>(h.ptr())).begin()->xxx_value_ptr<void>();  // holder_type not applicable here.
            return true;
        }
